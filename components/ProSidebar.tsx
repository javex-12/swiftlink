  ...
  return (
    <>
      ...
      <aside
        ...
        className={cn(
          "flex flex-col border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-950 transition-all duration-300 ease-in-out max-lg:fixed max-lg:bottom-0 max-lg:left-0 max-lg:top-0 max-lg:z-50 max-lg:w-72 max-lg:shadow-2xl lg:sticky lg:top-0 lg:z-30 lg:h-screen lg:shrink-0 lg:translate-x-0 lg:border-r overflow-hidden",
          mobileOpen ? "max-lg:translate-x-0" : "max-lg:-translate-x-full",
          isHovered ? "lg:w-64" : "lg:w-20"
        )}
      >
        <div className="p-5 border-b border-slate-100 dark:border-slate-800 flex items-center gap-3 h-20 shrink-0 overflow-hidden bg-slate-50/50 dark:bg-slate-900/20">
        ...
        <div className="p-3 border-t border-slate-100 dark:border-slate-800 space-y-1.5 overflow-hidden">
          ...
          <button
            ...
            data-tour-copy-shop
            className="flex w-full items-center gap-4 rounded-xl px-3.5 py-2.5 text-left text-xs font-bold text-slate-600 dark:text-slate-400 hover:bg-slate-50 dark:hover:bg-slate-900 transition-colors group"
          >
          ...
          <button
            ...
            className="flex w-full items-center gap-4 rounded-xl px-3.5 py-2.5 text-left text-xs font-black text-slate-700 dark:text-slate-300 hover:bg-slate-50 dark:hover:bg-slate-900 transition-colors group"
          >
        ...
        <div className="p-3 border-t border-slate-100 dark:border-slate-800 h-20 shrink-0 flex items-center overflow-hidden">
          <button
            ...
            className={cn(
              ...
              isHovered ? "bg-red-50 dark:bg-red-950/20 text-red-600 hover:bg-red-100 dark:hover:bg-red-900/30" : "text-slate-400 hover:text-red-600"
            )}
          >
