...
const HERO_TEMPLATES: SectionTemplate[] = [
  {
    id: "hero-1",
    type: "hero",
    name: "Brutalist Blackout",
    title: "Drop Season",
    subtitle: "Oversized type, raw energy — zero compromise on style.",
    content: { buttonText: "Shop Now", templateId: "hero-1" },
  ...
  },
  {
    ...
    subtitle: "Clean editorial split with your image on the right panel.",
  ...
  },
  {
    ...
    name: "Glass Dark",
    title: "Premium Grade",
    subtitle: "Frosted glass card centered on a dark ambient gradient.",
    content: { buttonText: "Explore Now", templateId: "hero-3" },
    preview: HERO_IMAGES[2],
  },
  {
    id: "hero-4",
    type: "hero",
    ...
    subtitle: "Live 3D torus knot spinning with your accent color.",
    content: { buttonText: "Discover", templateId: "hero-4" },
    preview: HERO_IMAGES[3],
  },
  {
    id: "hero-5",
    type: "hero",
    name: "Diagonal Split",
    title: "New Season",
    subtitle: "Bold diagonal background cut — accent meets white canvas.",
    content: { buttonText: "Shop Now", image: HERO_IMAGES[4], templateId: "hero-5" },
    preview: HERO_IMAGES[4],
  },
  {
    id: "hero-6",
    type: "hero",
    ...
    subtitle: "Animated 3D grid floor with full-bleed cinematic dark.",
    content: { buttonText: "Enter Store", templateId: "hero-6" },
    preview: HERO_IMAGES[5],
  },
  {
    id: "hero-7",
    type: "hero",
    ...
    subtitle: "Clean white editorial layout — image right, copy left.",
    content: { buttonText: "Shop Now", image: HERO_IMAGES[6], templateId: "hero-7" },
    preview: HERO_IMAGES[6],
  },
  {
    id: "hero-8",
    type: "hero",
    name: "Gradient Bold",
    title: "Make It Yours",
    subtitle: "Full-bleed accent gradient behind giant centered type.",
    content: { buttonText: "Get Started", templateId: "hero-8" },
    preview: HERO_IMAGES[7],
  },
  {
    id: "hero-9",
    type: "hero",
    name: "Poster Brutalist",
    title: "New Drop 2026",
    subtitle: "Newspaper poster energy — thick borders and hard offset shadows.",
    content: { buttonText: "View Collection", templateId: "hero-9" },
    preview: HERO_IMAGES[8],
  },
  {
    id: "hero-10",
    type: "hero",
    ...
    subtitle: "Live 3D organic sphere on cinematic dark background.",
    content: { buttonText: "Shop Now", templateId: "hero-10" },
    preview: HERO_IMAGES[9],
  },
];
